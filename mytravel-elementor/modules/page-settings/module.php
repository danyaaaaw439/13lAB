...
class Module extends BaseModule {
	...
	public function add_header_controls( Document $page, $option_group = '' ) {
		...
		if ( ! empty( wp_get_attachment_url( $elementor_logo_id['id'] ) ) ) {
			$header_custom_logo_field['default'] = [
		...
		$header_mytravel_transparent_logo_field = [
		...
		if ( ! empty( wp_get_attachment_url( $elementor_transparent_logo_id['id'] ) ) )  {
			$header_mytravel_transparent_logo_field['default'] = [
		...
		$header_mytravel_sticky_logo_field = [
		...
		if ( ! empty( wp_get_attachment_url( $elementor_sticky_logo_id['id'] ) ) ) {
			$header_mytravel_sticky_logo_field['default'] = [
