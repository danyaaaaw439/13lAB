    ...
    public static void main(String[] args) {
        ...
        switch (choice) {
            ...
            case 8: {
                ...
                if (foundNum != -1) {
                    System.out.println("First number with strictly increasing digits: " + foundNum);
                } else {
            ...
            case 9: {
                ...
                System.out.println("Decimal number " + decimalNumber + " is written as 100 in base " + base);
                break;
            }
